...
本项目提供中文 GUI，支持摄像头、照片、视频三种输入方式，并可实时显示手部关键点检测结果与机器人手可视化效果。下面展示系统的实际运行界面与演示效果。
...
系统启动后，用户可以在同一窗口中选择摄像头、照片或视频三种输入方式，并切换仿真视角、姿态平滑、坐标轴与手指名称显示等选项。

<div align="center">
  <img src="docs/images/gui_idle.png" alt="GUI Idle" width="80%" />
</div>
...
下图展示了系统在摄像头模式和视频模式下的运行界面。左侧为输入控制区域，中间为手部图像与关键点检测结果，右侧为机器人手实时可视化，下方显示 finger angles、qpos 和运行日志。

<table>
  <tr>
    <td align="center" width="50%">
      <img src="docs/images/gui_camera.png" alt="GUI Camera" width="100%" />
      <br>
      <b>摄像头模式</b>
    </td>
    <td align="center" width="50%">
      <img src="docs/images/gui_video.png" alt="GUI Video" width="100%" />
      <br>
      <b>视频模式</b>
    </td>
  </tr>
